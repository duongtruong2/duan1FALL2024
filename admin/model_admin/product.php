...
{
    $sql= "INSERT INTO `products` (`product_id`, `product_name`, `product_price`, `discounted_price`, `product_describe`, `category_id`, `status`)
                                    VALUES (NULL, '$product_name', '$product_price', '$discounted_price', '$product_describe', '$category_id', '$product_status');
";
